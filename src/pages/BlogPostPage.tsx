...
export default function BlogPostPage({ article, children, htmlContent }: BlogPostPageProps) {
  const headerImage = article.imageUrl || staticImages[article.slug];
      ...
      <header className="relative bg-bg-2 pb-12 pt-24 lg:pb-16 lg:pt-32">
        {headerImage && (
          <div className="mx-auto mb-8 max-w-[820px] px-5">
            <img src={headerImage} alt={article.title} className="w-full rounded-xl" />
          </div>
        )}
